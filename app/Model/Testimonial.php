...
class Testimonial extends Eloquent  {
	...
	*/
	...
	public function accordingLanguage()
    {
        ...
        return $this->hasMany('TestimonialDescription','parent_id')->select('client_name','comment','parent_id','designation')->where('language_id' , $currentLanguageId);
	...
	public function get_all_testimonial() {
        $result = Testimonial::where('is_active',IS_ACTIVE)->orderBy('id','ASC')->get()->toArray();
		return $result;
