...
use App\Model\PdfAction;
use Illuminate\Routing\Route;
use mjanssen\BreadcrumbsBundle\Breadcrumbs as Breadcrumb;
use Auth,Blade,Config,Cache,Cookie,DB,File,Hash,Input,Mail,mongoDate,Redirect,Request,Response,Session,URL,View,Validator;

/**
* Pdftemplate Controller
*
...
*/
	public function listTemplate(){
		...
		return  View::make('front.pdftemplates.index', compact('result','searchVariable','sortBy','order','query_string'));
	}// end listTemplate()
...
*/
	public function addTemplate(){
		$Action_options	=	PdfAction::orderBy('id','ASC')->lists('action','action');
		return  View::make('front.pdftemplates.add',compact('Action_options'));
	}// end addTemplate()
...
*/
	public function saveTemplate(){
		...
		if ($validator->fails())
		{	
			return Redirect::to('pdf-manager/add-template')
			...
			Session::flash('flash_notice', trans("PDF template added successfully")); 
			return Redirect::intended('pdf-manager');
		}
	}//  end saveTemplate()
...
*/
	public function editTemplate($Id){
		$Action_options	=	PdfAction::orderBy('id','ASC')->lists('action','action')->toArray();
		$emailTemplate	=	PdfTemplate::find($Id);
		if(empty($emailTemplate)) {
			return Redirect::to('pdf-manager');
		}
		return  View::make('front.pdftemplates.edit',compact('Action_options','emailTemplate'));
	} // end editTemplate()
...
*/
	public function updateTemplate($Id){
		...
		if ($validator->fails())
		{	
			return Redirect::to('pdf-manager/edit-template/'.$Id)
				->withErrors($validator)->withInput();
		}else{
			PdfTemplate::where('id', $Id)
				->update(
					array(
						//'name'		 	=> Input::get('name'),
						'subject' 		=> Input::get('subject'),
			...
			Session::flash('flash_notice', trans("PDF template updated successfully")); 
			return Redirect::intended('pdf-manager');
		}
	} // end updateTemplate()
...
*/
	public function getConstant(){
		if(Request::ajax() && Input::get()){
			...
			$options		= 	PdfAction::where('action', '=', $constantName)->orderBy('id','ASC')->lists('options','action'); 
