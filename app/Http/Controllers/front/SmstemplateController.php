...
*/
	public function listTemplate(){
		...
		return  View::make('front.smstemplates.index', compact('result','searchVariable','sortBy','order','query_string'));
	}// end listTemplate()
...
*/
	public function addTemplate(){
		$Action_options	=	SmsAction::lists('action','action');
		return  View::make('front.smstemplates.add',compact('Action_options'));
	}// end addTemplate()
...
*/
	public function saveTemplate(){
		...
		if ($validator->fails())
		{	
			return Redirect::to('sms-manager/add-template')
			...
			Session::flash('flash_notice', trans("Sms template added successfully")); 
			return Redirect::intended('sms-manager');
		}
	}//  end saveTemplate()
...
*/
	public function editTemplate($Id){
		$Action_options	=	SmsAction::lists('action','action')->toArray();
		$emailTemplate	=	SmsTemplate::find($Id);
		if(empty($emailTemplate)) {
			return Redirect::to('sms-manager');
		}
		return  View::make('front.smstemplates.edit',compact('Action_options','emailTemplate'));
	} // end editTemplate()
...
*/
	public function updateTemplate($Id){
		...
		if ($validator->fails())
		{	
			return Redirect::to('sms-manager/edit-template/'.$Id)
				->withErrors($validator)->withInput();
		}else{
			SmsTemplate::where('id', $Id)
				->update(
					array(
						//'name'		 	=> Input::get('name'),
						'subject' 		=> Input::get('subject'),
			...
			Session::flash('flash_notice', trans("Sms template updated successfully")); 
			return Redirect::intended('sms-manager');
		}
	} // end updateTemplate()
...
*/
	public function getConstant(){
		if(Request::ajax() && Input::get()){
			...
			$options		= 	SmsAction::where('action', '=', $constantName)->lists('options','action'); 
