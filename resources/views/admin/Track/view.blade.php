				...
				<div class="tracking_map_li_blk">
					<div class="tracking_map_li_content_blk">
						<div class="tracking_map_id_info_blk">
							<div class="tracking_map_id_title">Himanshu</div>
							<div class="tracking_map_id_date">Mar 07, 2020 <span>10:00 PM</span></div>
							<div class="clearfix"></div>
						</div>
						
						<div class="tracking_map_id_desc_blk">
							<div class="tracking_map_id_desc">
								<div class="tracking_map_id_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
								<div class="tracking_map_id_address">S-3/5-4, Sector-4, Kiran Path, Madhyam Marg, Mansarovar, Mansarovar</div>
							</div>
							<div class="tracking_map_id_img" style="background-image:url('https://s3.envato.com/files/280265188/01_Makalu_Preview/01_makalu_tf_preview.png')"></div>
							<div class="clearfix"></div>
						</div>
					</div>
