...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Edit How It Works</li>
	</ol>
</section>
		...
		<div class="col-md-6">
			...
			<div class="form-group <?php echo ($errors->first('image')) ? 'has-error' : ''; ?>">
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						?>
						@if($image && File::exists(HOWITWORK_ROOT_PATH.$model->image))
							{{ HTML::image( HOWITWORK_URL.$model->image, $model->image , array( 'width' => 70, 'height' => 70 )) }}
						@endif
			...
			<div class="form-group <?php echo ($errors->first('order')?'has-error':''); ?>">
				<div class="mws-form-row ">
					...
					<div class="mws-form-item">
						{{ Form::text("order",$model->how_order, ['class' => 'form-control small']) }}
						<div class="error-message help-inline">
			...
			<div id="{{ $i }}div" class="tab-pane {{ ($i ==  $language_code )?'active':'' }} ">
				...
				<div class="mws-form-inline">
					<div class="form-group <?php  if($value -> id == 1) {  echo ($errors->first('name')) ? 'has-error' : '';} ?>">
						...
						@endif
						<div class="mws-form-item">
							{{ Form::text("data[$i][name]",isset($multiLanguage[$i]['name'])?$multiLanguage[$i]['name']:'', ['class' => 'form-control small']) }}
							<div class="error-message help-inline">
