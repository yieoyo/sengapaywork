...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="{{URL::to('admin/users')}}">{{ trans("Users Managementt") }}</a></li>
...
<section class="content"> 
	...
	<div class="row pad">
		<div class="col-md-6">	
			...
			<div class="form-group <?php echo ($errors->first('gender')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::select('gender',array('male'=>'Male','female'=>'Female','other'=>'Other'),'',['class' => 'form-control','placeholder'=>'Select Gender']) }}
					<div class="error-message help-inline">
			...
			<div class="form-group <?php echo ($errors->first('date_of_birth')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::text("date_of_birth",'', ['class'=>'form-control dob','readonly'=>'readonly','data-format'=>"YYYY-MM-DD",'data-template'=>"D MMM YYYY"]) }}
					<div class="error-message help-inline">
		...
		<div class="col-md-6">
			...
			<div class="form-group <?php echo ($errors->first('country')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::select('country',[''=>'Select Country']+$country_list,'',['class'=>'form-control']) }}
					<div class="error-message help-inline">
			...
			<div class="form-group <?php echo ($errors->first('address')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::textarea('address','',['class'=>'form-control','rows'=>false,'cols'=>false]) }}
					<div class="error-message help-inline">
	...
	<div class="mws-button-row">
		<div class="input" >
			...
			<a href="{{URL::to('admin/users/add-user')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans("messages.user_management.reset") }}</a>
