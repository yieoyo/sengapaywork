	...
	<div class="row pad">
		...
		{{ Form::open(['role' => 'form','url' => 'admin/email-manager/edit-template/'.$emailTemplate->id,'class' => 'mws-form']) }}
			...
			<div class="mws-button-row">
				...
				<a href="{{URL::to('admin/email-manager/edit-template/'.$emailTemplate->id)}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset')  }}</a>
