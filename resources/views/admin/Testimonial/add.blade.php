	...
	<div class="row pad">
		<div class="col-md-6">	
			...
			<div class="form-group <?php    echo ($errors->first('winning_amount')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::text("winning_amount",'', ['class' => 'form-control']) }}
					<div class="error-message help-inline">
			...
			<div class="mws-panel-body no-padding tab-content"> 
					...
					<div id="{{ $i }}div" class="tab-pane {{ ($i ==  $language_code )?'active':'' }} ">
						<div class="mws-form-inline">
							<div class="form-group <?php  if($value -> id == 1) {  echo ($errors->first('client_name')) ? 'has-error' : '';} ?>">
								...
								@endif
								<div class="mws-form-item">
									{{ Form::text("data[$i][client_name]",'', ['class' => 'form-control']) }}
									<div class="error-message help-inline">
							...
							<div class="form-group <?php  if($value -> id == 1) {  echo ($errors->first('comment')) ? 'has-error' : '';} ?>">
								...
								@endif
								<div class="mws-form-item">
									{{ Form::textarea("data[$i][comment]",'', ['class' => 'form-control','id' => 'comment'.$i]) }}
									<div class="error-message help-inline">
				...
				<div class="mws-button-row">
					...
					<a href="{{URL::to('admin/testimonial-manager/add-testimonial')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset')  }}</a>
