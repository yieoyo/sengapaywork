...
<div class="mws-panel grid_8">
	...
	@endif
	{{ Form::open(['role' => 'form','url' =>'text-setting/save-new-text','class' => 'mws-form']) }}
	...
	<div class="mws-button-row">
		<div class="input" >
			...
			<a href="{{URL::to('text-setting/add-new-text')}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans("messages.settings.reset") }}</a>
		</div>
	</div>
