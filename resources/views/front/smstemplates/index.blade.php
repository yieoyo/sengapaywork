			...
			<div class="kt-container ">
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						...
						{{ trans("messages.header.sms_template") }} </h3>
					<div class="kt-subheader__breadcrumbs">
						...
						<span class="kt-subheader__breadcrumbs-separator"></span>
						<span class="kt-subheader__breadcrumbs-link">
							{{ trans("messages.header.sms_template") }} </span>
					</div>
				</div>
								...
								?>
								 ...
								 <tr>
									...
									<td style="text-align: right;">
									   ...
									   <a href="{{URL('/sms-manager/edit-template/'.$record->id)}}"><i class="flaticon-edit-1"></i>
									   {{ trans("messages.edit_book_plan.edit") }}</a>
									   </span>
									   <span class="test_temp_btn">
									   <a href="javascript:void(0);" class="sendTestSms" data-action-name="{{$record->action}}"><i class="flaticon-email"></i>
									   {{ trans("messages.sms_template.test_sms") }}</a>
									   </span>
									</td>
								 </tr>
							 <?php
