			...
			<div class="kt-container ">
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						...
						{{ trans("messages.email_template.edit_sms_template") }} </h3>
		...
		<div class="kt-container  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
				...
				<div class="kt-portlet">
					...
					{{ Form::open(['role' => 'form','url' => 'sms-manager/edit-template/'.$emailTemplate->id,'class' => 'kt-form kt-form--label-left']) }}
								...
								<div class="kt-section__body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											...
											<span class="form-text text-muted help-inline">
												Total characters <b class="totalCharacters"></b>
...
$(document).ready(function(){
	var totalChar = $("#body").val().length;
	$(".totalCharacters").text(totalChar);
})
