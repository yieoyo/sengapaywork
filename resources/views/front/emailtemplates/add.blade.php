				...
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						<button class="kt-subheader__mobile-toggle kt-subheader__mobile-toggle--left" id="kt_subheader_mobile_toggle"><span></span></button>
						 {{ trans("messages.email_template.add_email_template") }}</h3>
		...
		<div class="kt-container  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
				...
				<div class="kt-portlet">
					...
					{{ Form::open(['role' => 'form','url' => 'email-manager/add-template','class' => 'kt-form kt-form--label-left']) }}
						<div class="kt-portlet__body">
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="form-group row">
										{{ HTML::decode( Form::label('name',trans("messages.email_template.subject"), ['class' => 'col-sm-2 col-form-label'])) }}
										<div class="col-sm-4">
											<div class="input-group">
									...
									<div class="form-group row">
										{{ HTML::decode( Form::label('action',trans("messages.email_template.email_action"), ['class' => 'col-sm-2 col-form-label'])) }}
										<div class="col-sm-4">
											<div class="input-group">
