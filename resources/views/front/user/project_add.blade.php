			...
			<div class="kt-container ">
				<div class="kt-subheader__main">
					...
					<div class="kt-subheader__breadcrumbs">
						...
						<span class="kt-subheader__breadcrumbs-separator"></span>
						<span class="kt-subheader__breadcrumbs-link"> Add Project </span>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="kt-portlet">
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label">
							<h3 class="kt-portlet__head-title">Add Project Form</h3>
						</div>
					</div>
					{{ Form::open(['role' => 'form','url'=>"project-save", 'class'=>'kt-form kt-form--label-left', 'id'=>"addProjectForm"]) }}
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('name','',['class'=>'form-control','autocomplete'=>'off', 'aria-describedby'=>'basic-addon1', 'placeholder'=>trans('Enter Project name')]) }}
											</div>
							...
							<div class="kt-form__actions">
								<div class="row">
									...
									<div class="col-lg-10 col-xl-10">
										<input type="button" onclick="saveRoom(1)" value="Save" class="btn btn-success btn_1">&nbsp;
										<input type="button" onclick="saveRoom(2)" class="btn btn-brand btn_2" value="Save & Create New" >&nbsp;
