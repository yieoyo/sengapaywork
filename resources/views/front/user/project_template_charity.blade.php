				...
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						...
						<div class="kt-subheader__breadcrumbs">
							...
							<span class="kt-subheader__breadcrumbs-separator"></span>
							<a href="" class="kt-subheader__breadcrumbs-link">
								{{ trans('messages.project_templates_charity.charity') }} </a>
							<span class="kt-subheader__breadcrumbs-separator"></span>
							<a href="" class="kt-subheader__breadcrumbs-link">
							...
							<div class="kt-section__body">
								...
								<div class="form-group row">
									...
									<div class="col-2">
										<div class="kt-checkbox-inline">
											<label class="kt-checkbox">
												<input class="" name="client_view" type="checkbox" value="1"> {{ trans('messages.project_templates_dana_lestari.enable_client_view') }} 
												<span></span>
											</label>
										</div>
									</div>
					...
					<div class="kt-portlet__body">
						<div class="tab-content">
							...
							<div class="tab-pane" id="kt_widget5_tab3_content">
								<div class="form-group row">
									<label class="col-3 col-form-label">Project Plan:</label>
									<div class="col-9">
										<div class="daily_plan_block">
										...
										<section class="form-group delete_more_daily_plan_0" rel="0">
											<div class="row">
												<div class="col-2 form-group">
													<label class="form-label">{{ trans('messages.sub_project_lists.project_plan') }}:</label>
													<div class="input-group">
														<div class="input-group-prepend"><span class="input-group-text">
														{{ trans("messages.sub_project_detail.rm")}}</span></div>
														{{ Form::text('target_amount', '', ['class'=>'form-control','aria-describedby'=>'basic-addon1','autocomplete'=>'off', 'placeholder'=>'1000']) }} 
							...
							<div class="tab-pane" id="kt_widget5_tab4_content">
								...
								<div class="form-group row">
									...
									<div class="col-5">
										{{ Form::text('field_name', '', ['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans("messages.project_template.enter_section_title")]) }}
									</div>
								</div>
										...
										<section class="form-group delete_more_daily_plan_0" rel="0">
											<div class="row">
												<div class="col-3 form-group">
													...
													<div class="input-group">
														<div class="input-group-prepend"><span class="input-group-text">
														{{ trans("messages.sub_project_detail.rm")}}
														</span></div>
														{{ Form::text('target_amount', '', ['class'=>'form-control','aria-describedby'=>'basic-addon1','autocomplete'=>'off', 'placeholder'=>'100']) }} 
													</div>
												</div>
