	...
	<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
			...
			<div class="kt-container ">
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						...
						{{ trans("messages.cms_pages.add_cms_page") }} </h3>
					<div class="kt-subheader__breadcrumbs">
						...
						<span class="kt-subheader__breadcrumbs-separator"></span>
						<span class="kt-subheader__breadcrumbs-link">  {{ trans("messages.cms_pages.add_cms_page") }}</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="kt-container  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
				...
				<div class="col-sm-12">
					{{ Form::open(['role' => 'form','url'=>"cms-pages-save", 'class'=>'kt-form kt-form--label-left', 'id'=>"addCmsPageForm"]) }}
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('page_name','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_page_title')]) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('slug','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_page_slug')]) }}
											</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
										...
										<div class="col-sm-4">
											<div class="kt-radio-inline">
												<label class="kt-radio">
													{{ Form::radio('theme','0','1',['class'=>'']) }} {{trans('messages.cms_pages.default')}}
													<span></span>
												</label>
												<label class="kt-radio">
													{{ Form::radio('theme','1','',['class'=>'']) }} {{trans('messages.cms_pages.top')}}
													<span></span>
												</label>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('title','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_main_title_english')]) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('title_ms','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_main_title_malay')]) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('sub_title','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_subtitle_english')]) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::text('sub_title_ms','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.enter_subtitle_malay')]) }}
											</div>
											<span class="form-text text-muted sub_title_ms_error"></span>
										</div>
									</div>
									<div class="form-group row" style="display:none;">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::color('font_color','#563d7c',['class'=>'form-control']) }}
											</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												{{ Form::textarea('body','',['class'=>'form-control','autocomplete'=>'off', 'id'=>'body']) }}
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												{{ Form::textarea('body_ms','',['class'=>'form-control','autocomplete'=>'off', 'id'=>'body_ms']) }}
												<script type="text/javascript">
													// For CKEDITOR //
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::select('project',$projectLists,'',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.select_project')]) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="kt-radio-inline">
												<label class="kt-radio">
													{{ Form::radio('arrangement','1','1',['class'=>'']) }} {{trans('messages.admin_dashboard.all')}}
													<span></span>
												</label>
												<label class="kt-radio">
													{{ Form::radio('arrangement','2','',['class'=>'']) }} {{ trans('messages.cms_pages.group') }}
													<span></span>
												</label>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group">
												{{ Form::select('sub_project_row',$SubProjectRows,'',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.cms_pages.select_subproject_row')]) }}
											</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												{{ Form::textarea('footer_body','',['class'=>'form-control','autocomplete'=>'off', 'id'=>'footer_body']) }}
												<script type="text/javascript">
													// For CKEDITOR //
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												{{ Form::textarea('footer_body_ms','',['class'=>'form-control','autocomplete'=>'off', 'id'=>'footer_body_ms']) }}
												<script type="text/javascript">
													// For CKEDITOR //
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="kt-radio-inline">
												...
												<label class="kt-radio">
													{{ Form::radio('contactus_status','0','',['class'=>'']) }} {{trans('messages.cms_pages.disable')}}
													<span></span>
												</label>
											</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<div class="input-group">
												{{ Form::text('meta_title','',['class'=>'form-control','autocomplete'=>'off']) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<div class="input-group">
												{{ Form::text('meta_keyword','',['class'=>'form-control','autocomplete'=>'off']) }}
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<div class="input-group">
												{{ Form::textarea('meta_description','',['class'=>'form-control','autocomplete'=>'off','rows'=>'10']) }}
											</div>
...
function saveCmsPage(KeyVal){
	...
	$.ajax({
		url: '{{ route("User.GeneralCmsPagesSave") }}',
		type:'POST',
		data: $('#addCmsPageForm').serialize(),
