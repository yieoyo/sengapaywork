<section class="form-group delete_more_yearly_plan_{{$counter}}" rel="{{$counter}}">
	...
	<div class="row">
		<div class="col-3 input-group">
			...
			{{ Form::text('YearlyPlan['.$counter.'][price]', '', ['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>'']) }}
		</div>
		<div class="col-2">
			<div class="kt-checkbox-inline">
				<label class="kt-checkbox">
					{{ Form::radio('YearlyPlan_is_primary',$counter,'', ['class'=>'']) }} {{ trans('messages.sub_project_detail.primary') }}
					<span></span>
				</label>
			</div>
		</div>
		<div class="col-2">
			<button type="button" onclick="deleteMoreYearlyPlan({{$counter}})" class="btn btn-label-danger"><i class="la la-trash"></i>
