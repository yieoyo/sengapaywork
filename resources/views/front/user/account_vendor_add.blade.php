				...
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						<button class="kt-subheader__mobile-toggle kt-subheader__mobile-toggle--left" id="kt_subheader_mobile_toggle"><span></span></button>
						 {{ trans('messages.account_vendors.add_vendor')}}</h3>
					<div class="kt-subheader__breadcrumbs">
						...
						<span class="kt-subheader__breadcrumbs-separator"></span>
						<a href="#" class="kt-subheader__breadcrumbs-link">
							{{ trans('messages.account_vendors.add_vendor')}}</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="kt-portlet">
						<div class="kt-portlet__head">
							<div class="kt-portlet__head-label">
								<h3 class="kt-portlet__head-title">{{ trans('messages.account_vendors.add_vendor_form')}}</h3>
							</div>
						</div>
						{{ Form::open(['role' => 'form','url'=>"vendor-save", 'class'=>'kt-form kt-form--label-left', 'id'=>"addSalesPersonForm"]) }}
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::text('vendor_name','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.personal_information.enter_full_name')]) }}
								...
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::text('vendor_phone','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.admin_account.enter_contact_number')]) }}
										<span class="form-text text-muted"></span>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										<div class="input-group">
											...
											{{ Form::text('vendor_email','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans(''), 'aria-describedby'=>'basic-addon1']) }}
										</div>
								...
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::select('is_active',array('1'=>trans('messages.navigation.active'),'0'=>
										trans('messages.language_settings.in_active') ),'', ['class'=>'form-control', 'autocomplete'=>'off', 'placeholder'=>trans('messages.admin_account.select_status')]) }}
								...
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::textarea('short_description','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('messages.admin_account.short_description')]) }}
										<span class="form-text text-muted"></span>
									</div>
								</div>
									...
									<div class="form-group cot_form_input_holder">
										...
										<div class="kt-checkbox-inline">
											<label class="kt-checkbox">
												{{ Form::checkbox('payment_method[]',1,'', ['class'=>'']) }} QR Code
												<span></span>
											</label>
											<label class="kt-checkbox">
												{{ Form::checkbox('payment_method[]',2,'', ['class'=>'']) }} Cash
												<span></span>
											</label>
											<label class="kt-checkbox">
												{{ Form::checkbox('payment_method[]',3,'', ['class'=>'']) }} CDM
												<span></span>
											</label>
											<label class="kt-checkbox">
												{{ Form::checkbox('payment_method[]',4,'', ['class'=>'']) }} Bank Transfer
												<span></span>
											</label>
										</div>
								...
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::text('deposit','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('Enter allowed deposit per guest')]) }}
										<span class="form-text text-muted"></span>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::text('commission','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('Enter commission per package')]) }}
										<span class="form-text text-muted"></span>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group cot_form_input_holder">
										...
										{{ Form::text('refrral_id','',['class'=>'form-control','autocomplete'=>'off', 'placeholder'=>trans('Enter Sales Person Refrral ID')]) }}
										<span class="form-text text-muted"></span>
									</div>
								</div>
								 */ ?>
							...
							<div class="kt-form__actions">
								<div class="row">
									<div class="col-lg-9 col-xl-9">
										<input type="button" onclick="saveSalesPerson(1)" value='{{ trans("messages.general_setting.save") }}' class="btn btn-success btn_1">&nbsp;
										<input type="button" onclick="saveSalesPerson(2)" class="btn btn-brand btn_2" value="{{ trans('messages.cms_pages.save_create_new') }}" >&nbsp;
...
function saveSalesPerson(KeyVal){
	...
	$.ajax({
		url: '{{ route("User.AccountVendorSave") }}',
		type:'POST',
		data: $('#addSalesPersonForm').serialize(),
		success: function(r){
