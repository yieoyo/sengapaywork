				...
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">
						<button class="kt-subheader__mobile-toggle kt-subheader__mobile-toggle--left" id="kt_subheader_mobile_toggle"><span></span></button>
							{{ trans('messages.account_vendors.vendors_management')}}</h3>
					<div class="kt-subheader__breadcrumbs">
						...
						<span class="kt-subheader__breadcrumbs-link">
							{{ trans('messages.header.vendors')}}</span>
					</div>
				</div>
				<div class="kt-subheader__toolbar">
					<div class="kt-subheader__wrapper">
						<a href="{{route('User.exportVendorExcel')}}" class="btn kt-subheader__btn-secondary">
				...
				<div class="kt-portlet">
					...
					<div class="kt-portlet__head kt-portlet__head--lg">
						<div class="kt-portlet__head-label">
							...
							<h3 class="kt-portlet__head-title">
								{{ trans('messages.account_vendors.vendor_list')}}
							</h3>
						</div>
						<div class="kt-portlet__head-toolbar">
							<div class="kt-portlet__head-wrapper">
								...
								<a href="{{URL('/vendor-add')}}" class="btn btn-brand btn-icon-sm">
					...
					<div class="kt-portlet__body">
						...
						<div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
							{{ Form::open(['role' => 'form','URL' => '/account-vendors','method'=>'get','class' => 'mws-form','files'=>'true','id'=>'searchsalesPersonForm']) }}
							<div class="row align-items-center">
								<div class="col-xl-8 order-2 order-xl-1">
									<div class="row align-items-center">
										...
										<a href="{{ route('user.account_vendors') }}" class="btn btn-danger">{{ trans('messages.sub_project_lists.reset') }}</a>
									</div>
								</div>
							</div>
							{{ Form::close() }}
							...
							<thead class="kt-datatable__head">
								<tr class="kt-datatable__row" style="left: 0px;">
									...
									<th data-field="FirstName" data-autohide-disabled="false" class="kt-datatable__cell kt-datatable__cell--sort">
										<span style="width: 200px;">{{ trans('messages.account_vendors.vendor_name')}}</span>
									</th>
									<th data-field="VendorNumber" data-autohide-disabled="false" class="kt-datatable__cell kt-datatable__cell--sort">
										<span style="width: 200px;">{{ trans('messages.account_vendors.vendor_number')}}</span>
									</th>
									<th data-field="Email" data-autohide-disabled="false" class="kt-datatable__cell kt-datatable__cell--sort">
										<span style="width: 200px;">{{ trans('messages.account_vendors.vendor_email')}}</span>
									</th>
								...
								<tr data-row="0" class="kt-datatable__row" style="left: 0px;">
									...
									<td data-field="Actions" class="kt-datatable__cell">
										...
										<span style="overflow: visible;position: relative;width: 100px;display: inline-block;">
													...
													<ul class="kt-nav">                                    
													  ...
													  @if($editaccountValGlobal != 0)	
														<li class="kt-nav__item">
															<a href="{{URL('/vendor-edit/'.$record->slug)}}" class="kt-nav__link"> 
														...
														@if($record->is_active == 1)
														<li class="kt-nav__item"> 
															<a href="{{URL('/change-status-vendor/'.$record->slug.'/0')}}" class="kt-nav__link">
														...
														@else
														<li class="kt-nav__item"> 
															<a href="{{URL('/change-status-vendor/'.$record->slug.'/1')}}" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-drop"></i>
													  ...
													  @endif
														<?php /* <li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
																...
																<span class="kt-nav__link-text">Generate Report</span>
															</a> 
														</li> */ ?>
													</ul>
												</div>
											...
											<a href="javascript:void();" class="delete_record btn btn-sm btn-clean btn-icon btn-icon-md" data-url="{{URL('/delete-vendor/'.$record->slug)}}">
